...
print(f'\n{guests[-1].title()} can\'t make it to dinner.\nLet\'s invite Balake instead!\n')

guests.remove('aaron')
guests.append('balake')
...
guests_more = ['Deenice', 'Ayayron']
guests = guests + guests_more
...
while len(guests) > 2:
  print(f'Sorry, {guests.pop().title()} there\'s no room at the table.')
  guests_number = len(guests)
